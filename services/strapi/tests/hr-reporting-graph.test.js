...
test('hr-reporting-lines is HR-only, reads included', () => {
  ...
  // services/core serves seeded CRUD through a generic handler that never reaches
  // the services/strapi controller, so a controller-side scope narrowing would apply
