 ...
 * services/strapi the REST core controller and the admin panel both land here, and
 * in services/core plain CRUD is served by a generic handler built on documents()
