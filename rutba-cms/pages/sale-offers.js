        ...
        <ProtectedRoute>
            <Layout>
                <div className="d-flex align-items-center justify-content-between mb-3">
                    <h2 className="mb-0">Sale Offers</h2>
                    <Link className="btn btn-primary btn-sm" href="/new/sale-offer">
                        <i className="fas fa-plus me-1"></i>New Sale Offer
                    </Link>
                </div>

                <p className="text-muted small mb-3">
                    Sale offers can be linked to product groups, CMS pages, and categories to display promotions uniformly across the site.
                </p>

                {loading && <p>Loading sale offers...</p>}

                {!loading && offers.length === 0 && (
                    <div className="alert alert-info">No sale offers found.</div>
                )}
                                ...
                                {offers.map(o => {
                                    ...
                                    return (
                                        <tr key={o.id}>
                                            ...
                                            <td>
                                                <Link href={`/${o.documentId}/sale-offer`} className="btn btn-sm btn-outline-primary">
