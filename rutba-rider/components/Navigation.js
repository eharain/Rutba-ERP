...
export default function Navigation() {
  ...
  return (
    <nav className="navbar navbar-expand-lg navbar-dark bg-dark px-3 text-white">
      <Link className="navbar-brand fw-bold" href="/delivery-offers">Rutba Rider</Link>
      <button className="navbar-toggler" type="button" data-bs-toggle="collapse" data-bs-target="#mainNav" aria-controls="mainNav" aria-expanded="false" aria-label="Toggle navigation">
        <span className="navbar-toggler-icon"></span>
      </button>
      <div className="collapse navbar-collapse" id="mainNav">
        <ul className="navbar-nav me-auto mb-2 mb-lg-0">
          <li className="nav-item"><Link className="nav-link" href="/delivery-offers">Delivery Offers</Link></li>
          <li className="nav-item"><Link className="nav-link" href="/deliveries">Active Deliveries</Link></li>
          <li className="nav-item"><Link className="nav-link" href="/history">Delivery History</Link></li>
          <li className="nav-item"><Link className="nav-link" href="/profile">Rider Profile</Link></li>
        </ul>
