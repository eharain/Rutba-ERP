        ...
        <nav className="navbar navbar-expand navbar-grey bg-light px-3 py-2 border-bottom">
            <ul className="navbar-nav align-items-center gap-2">
                ...
                <li className="nav-item">
                    <Link className="btn btn-sm btn-outline-primary" href="/posts">Posts</Link>
                </li>
                <li className="nav-item">
                    <Link className="btn btn-sm btn-outline-info" href="/replies">Replies</Link>
                </li>
                <li className="nav-item">
                    <Link className="btn btn-sm btn-outline-secondary" href="/accounts">Accounts</Link>
                </li>
                <li className="nav-item">
