    ...
    return (
        <ProtectedRoute>
            <Layout>
                ...
                {loading && <p>Loading web orders...</p>}

                {!loading && orders.length === 0 && (
                    <div className="alert alert-info">No web orders yet.</div>
                )}
                                        ...
                                        <tr key={order.id}>
                                            ...
                                            <td>
                                                <div className="d-flex gap-2 flex-wrap">
                                                    <Link className="btn btn-sm btn-outline-primary" href={`/${order.documentId || order.id}/sale-order`}>
                                                        View
                                                    </Link>
