...
Next.js pages-router app on **port 4023**, using the shared Rutba app shell (`BaseLayout`,
`Topbar`, `Sidebar`, `ProtectedRoute`) and the generated `@rutba/api-provider` clients. Its
backend is the Core-native helpdesk module at `services/core/src/modules/helpdesk.js`; the app
