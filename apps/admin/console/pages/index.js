...
const SECTIONS = [
    ...
    { href: "/social-relays", title: "Social Relay Providers", icon: "fa-tower-broadcast", tone: "warning", text: "Aggregator API keys (Ayrshare, Postiz) that social posts publish through. Email relaying is MTA; SMS is not built yet.", ready: true },
