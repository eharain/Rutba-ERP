...
async function save(id, data) {
    ...
    if (__verb === 'get') return authApi.fetch(ep.path, ep.params, epCtx(ep));
    if (__verb === 'delete') return authApi.del(withQuery(ep.path, ep.params), epCtx(ep));
    return authApi[__verb](withQuery(ep.path, ep.params), wrapData(ep.data), epCtx(ep));
}
