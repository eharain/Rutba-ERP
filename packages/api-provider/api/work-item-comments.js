 ...
 * authenticated user. Shared by the manufacturing, order-management, and mail
 * (shared-inbox internal notes) apps.
 */
export const WorkItemCommentsEndpoints = {

    meta: {
        uid: 'api::work-item-comment.work-item-comment',
        domains: ['mail', 'manufacturing', 'order-management'],
    ...
    list: ({ entityUid, targetDocumentId, page = 1, pageSize = 100, sort } = {}) => ({
        ...
        action: 'find',
        method: 'get',
        apps: ['mail', 'manufacturing', 'order-management'],
