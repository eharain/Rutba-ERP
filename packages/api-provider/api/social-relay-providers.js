 ...
 * registering a relay is instance administration and belongs to apps/admin/console,
...
export const SocialRelayProvidersEndpoints = {
    ...
    create: (data) => ({ path: '/social-relay-providers', action: 'create', method: 'post', apps: ['console'], data }),
    update: (documentId, data) => ({ path: `/social-relay-providers/${documentId}`, action: 'update', method: 'put', apps: ['console'], data }),
    del: (documentId) => ({ path: `/social-relay-providers/${documentId}`, action: 'delete', method: 'delete', apps: ['console'] }),
