 ...
 *
 * services/core serves seeded CRUD rows through a GENERIC handler
 * (`coreHandler(uid, action)` in services/core/src/http/server.js), not through the
 * services/strapi controller, so a controller-side `find` override that narrowed the
