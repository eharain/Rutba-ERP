...
export const SocialPostsEndpoints = {
    ...
    create: (data) => ({ path: '/social-posts', action: 'create', method: 'post', data }),
    update: (documentId, data) => ({ path: `/social-posts/${documentId}`, action: 'update', method: 'put', data }),
    publish: (documentId) => ({ path: `/social-posts/${documentId}/publish`, action: 'publish', method: 'post' }),
    unpublish: (documentId) => ({ path: `/social-posts/${documentId}/unpublish`, action: 'unpublish', method: 'post' }),
