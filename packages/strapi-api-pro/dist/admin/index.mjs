...
const PluginIcon = ({ width = 16, height = 16, ...rest }) => /* @__PURE__ */ jsxs(
  "svg",
  {
    ...
    ...rest,
    children: [
      /* @__PURE__ */ jsx("path", { d: "M16 2 4 6v9.2c0 6.7 4.7 12.6 12 14.8 7.3-2.2 12-8.1 12-14.8V6L16 2Z" }),
      /* @__PURE__ */ jsx(
        "path",
        {
          fill: "#fff",
...
const index = {
  register(app) {
    app.addMenuLink({
      ...
      Component: async () => {
        const { default: App } = await import("../_chunks/App-Bv_Rh5p1.mjs");
        return App;
      }
    });
    app.registerPlugin({
