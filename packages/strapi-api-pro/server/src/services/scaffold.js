...
function clientVerbForMethod(method) {
  ...
  if (httpMethod === 'patch') return 'put'; // collapse PATCH→put for StrapiClient
...
function emitMethod(method) {
  ...
  if (verb === 'get' || verb === 'delete') {
    ...
    // post / put — first body, then options
...
// if the file is missing — useful while authoring before the first save.
